...
\- \*\*User\_t\*\* – stores login credentials and roles  

\- \*\*Employee\*\* – stores employee details  

\- \*\*Customer\*\* – manages customer data  

\- \*\*Order\_T\*\* and \*\*Order\_Item\*\* – for order management  

\- \*\*Product\*\*, \*\*Category\*\*, and \*\*Supplier\*\* – for product and inventory management  

\- \*\*Login\_Audit\*\* – logs user login and logout activities
...
&nbsp;   <add name="myconnstr" connectionString="Data Source=YOUR\_SERVER;Initial Catalog=YOUR\_DB;Integrated Security=True" providerName="System.Data.SqlClient" />
